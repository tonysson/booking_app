...
export default function MyHotels() {
    ...
    if(!hotelData) {
        return <span className="">No hotel found</span>
    }
  ...
  return (
    <div className="space-y-5">
        ...
        <div className=" grid grid-cols-1 gap-8 ">
            {
                hotelData?.length && hotelData.map((hotel) => (
                    <div key={hotel._id} className="flex flex-col justify-between border border-slate-500 rounded-lg p-8 gap-5">
                        ...
                        <div className="grid grid-cols-5 gap-2">
                            ...
                            <div className="border border-slate-300 rounded-sm p-3 flex items-center">
                                ...
                                {hotel.starsRating} stars Rating 
                            </div>
                        </div>
